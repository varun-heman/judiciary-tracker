...
Coverage is uneven: some courts are detailed, some are roster-only, and others are placeholders. The [GitHub repository](https://github.com/varun-heman/judiciary-tracker) shows the current state of coverage and welcomes corrections or contributions.

The code and data are available under the [Apache 2.0 license](https://github.com/varun-heman/judiciary-tracker/blob/main/LICENSE). You are welcome to inspect, reuse, fork, or point out errors.
